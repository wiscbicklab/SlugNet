...
function FAQ() {
    ...
    const imageSrc = {
        ...
        "Google_Review_Account": "https://raw.githubusercontent.com/wiscbicklab/SlugNet/refs/heads/main/public/Images/Google_Review_Account_Instructions.png",
    ...
    const imageAlt = {
        ...
        "Google_Create_Account": "Google will now ask you to Sign in. Instead click on the create account text to open a drop-down menu and then click 'For my personal use'",
        ...
        "Google_Create_Email_Blank": "Google will now prompt you to create an email address with them. Instead click the 'Use your existing email' text below the box to enter your email.",
        ...
        "Google_Privacy_Dont_Save": "Under the more options section of the privacy page select Don't Save for Youtube history and Web & Activities. Additionally, select 'Show me ads that aren't personalized. Selecting these options will minimize the amount of information that Google keeps.",
        ...
        "SlugNet_Home": "On the SlugNet HomePage there is a set of Instructions for the website. The second Instruction contains a link to the registration page. Please click this link to proceed"
    };
    ...
    return (
        <div className="FAQ">
            ...
            {openFAQ === 'faq0' && 
                <div>
                    <div id='faq0' className="faq-download">
                        <a href="https://raw.githubusercontent.com/wiscbicklab/SlugNet/refs/heads/main/public/Create_Account_Existing_Email_Instructions.pdf">Download Instructions</a>
                    </div>
            ...
            {openFAQ === 'faq1' && 
                <div>
                    <div id='faq1' className="faq-download">
                        <a href="https://raw.githubusercontent.com/wiscbicklab/SlugNet/refs/heads/main/public/Create_Account_New_Email_Instructions.pdf">Download Instructions</a>
                    </div>
